...
const complianceStandards = ['PCI-DSS v4.0', 'HIPAA', 'ISO 27001', 'SOC 2 Type II', 'NIST Cybersecurity Framework', 'Custom'];
...
export default function CompliancePage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="font-headline text-3xl font-semibold">Compliance & Legal</h1>
        <p className="text-muted-foreground">Tools and references for cybersecurity governance and compliance.</p>
      </div>
