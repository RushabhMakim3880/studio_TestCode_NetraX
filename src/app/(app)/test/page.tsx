...
const OperatorV3SplashScreen = () => {
        ...
        const write = () => {
            ...
            setScrambled(prev => {
                return word.split('').map((char, i) => {
                    if (i < letterCount) return `<span>${word.charAt(i)}</span>`;
  ...
  <div className="relative h-full w-full flex flex-col items-center justify-center p-4 font-mono overflow-hidden" style={{ backgroundColor: 'rgb(0,0,0)'}}>
    <style jsx>{`
      ...
      .hide-logo-text :global(span) { display: none !important; }
      .logo-container > div { height: 100% !important; width: 100% !important; }
      .scrambled-text { font-size: 60px; text-shadow: 0 0 15px #411; color: #411; }
      .scrambled-text :global(.glow) { color: #f00; text-shadow: 0px 0px 10px #f00; }
      .scrambled-text :global(span) { display: inline-block; padding: 0 10px; }
    `}</style>
    <div className="w-full max-w-lg flex flex-col items-center text-center">
        <div className="h-24 w-24 text-white mb-4 logo-container">
            <Logo className="hide-logo-text h-full w-full" />
        </div>
        <h1 className="text-4xl font-bold tracking-widest text-white mt-4 relative glitch-text" data-text="NETRA-X">NETRA-X</h1>
        <div className="h-24 w-full flex items-center justify-center text-sm text-white/80 mt-12">
        ...
        <div className="relative h-full w-full flex flex-col items-center justify-center bg-black p-4 font-mono overflow-hidden">
            ...
            `}</style>
             <div id="deadline-container" key={animationKey}>
                <div id="logo-container" style={{width: '400px', height: '400px'}}><Logo /></div>
                <div id="deadline">
