...
const implementedFeatures = [
    ...
    { icon: Syringe, title: 'Vulnerability Analysis Tools', description: 'A suite of tools for vulnerability assessment, including an AI-driven Exploit Chain Assistant.', path: '/vapt' },
    ...
    { icon: Bot, title: 'AI Malware Concept Generator', description: 'Designs conceptual malware payloads with configurable C2 channels (e.g., DoH, Telegram).', path: '/offensive' },
    ...
    { icon: Workflow, title: 'Live Workflow Documentation Generator', description: 'Record actions and generate step-by-step PDF guides automatically.', path: '/dashboard' },
    { icon: Users, title: 'Team Collaboration Features', description: 'Assign tasks to users and manage project roles and permissions.', path: '/project-management' },
];
